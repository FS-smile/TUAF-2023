...
# Part I.2: Learning Triple Representations using multi-layer GCN (graph encoder)
class GCN(nn.Module):
...
# Part II: Triple Updating by Reconstruction (graph decoder)
...
# Part III: Adaptive Fusion Readout
...
class outlier_model(nn.Module):
    ...
    def forward(self, x_triple, tuple_adj, **kwargs):
